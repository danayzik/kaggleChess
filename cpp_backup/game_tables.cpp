...
// Tables
const std::array<int16_t, 64> mg_pawn_table = {
    0,   0,   0,   0,   0,   0,  0,   0,
...
const std::array<int16_t, 64> eg_pawn_table = {
    0,   0,   0,   0,   0,   0,   0,   0,
...
const std::array<int16_t, 64> mg_knight_table = {
...
const std::array<int16_t, 64> eg_knight_table = {
...
const std::array<int16_t, 64> mg_bishop_table = {
...
const std::array<int16_t, 64> eg_bishop_table = {
...
const std::array<int16_t, 64> mg_rook_table = {
...
const std::array<int16_t, 64> eg_rook_table = {
...
const std::array<int16_t, 64> mg_queen_table = {
...
const std::array<int16_t, 64> eg_queen_table = {
...
const std::array<int16_t, 64> mg_king_table = {
...
const std::array<int16_t, 64> eg_king_table = {
...
const std::array<const int16_t*, 6> mg_pesto_table = {
    mg_pawn_table.data(),
...
const std::array<const int16_t*, 6> eg_pesto_table = {
    eg_pawn_table.data(),
